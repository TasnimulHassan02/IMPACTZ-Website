        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#contact" className="bg-gradient-to-r from-brand-blue to-brand-purple hover:from-brand-purple hover:to-brand-blue text-white rounded-lg flex items-center py-[12px] px-[23px]">
                Get Started
                <ArrowRight size={18} className="ml-2" />
              </a>
              <a href="#services" className="border border-brand-blue text-brand-blue bg-white hover:bg-brand-light-blue rounded-lg border-width: 10 px text-center flex items-center justify-center sm:w-auto w-full transition-colors duration-200 py-[10px] my-0 mx-0 font-semibold px-[26px]">Our Services</a>
            </div>
          </div>

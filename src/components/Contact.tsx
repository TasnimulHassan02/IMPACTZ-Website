            ...
            <div className="bg-gradient-to-r from-brand-blue to-brand-purple p-8 text-white">
              ...
              <div className="mt-12">
                <div className="flex space-x-4">
                  <a href="https://mail.google.com/mail/u/2/#inbox?compose=CllgCJqXxmRxwJJGRhbddhVKVxqQdqHnGhjHLXntnFfrKhcbxjxlkrzzTSlGnFnDnXXbzzMSZGB" className="bg-white/20 hover:bg-white/40 transition-colors p-2 rounded-full">
                    <Mail className="w-5 h-5 text-white" />
                  </a>
                  <a href="www.linkedin.com/company/impactz2025/?viewAsMember=true" className="bg-white/20 hover:bg-white/40 transition-colors p-2 rounded-full">

...
const Navbar: React.FC = () => {
  ...
  return <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? "bg-white shadow-md py-2" : "bg-transparent py-4"}`}>
      <div className="container mx-auto flex justify-between items-center my-[5px]">
        <div className="flex items-center">
          ...
          }} src="/lovable-uploads/79060f61-d257-482d-8bb5-0fcf7b0eb3d0.png" className="h-11 ml--3" />
          </a>
        </div>
